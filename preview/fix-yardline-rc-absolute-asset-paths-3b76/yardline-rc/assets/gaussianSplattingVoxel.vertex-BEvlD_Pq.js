import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./sceneUboDeclaration-B5VhSG0v.js";import{t as n}from"./meshUboDeclaration-BmNu2KU_.js";import{c as r,n as i,s as a}from"./index-CkTf6pPR.js";var o=`gaussianSplattingVoxelVertexShader`,s=`#include<__decl__gaussianSplattingVertex>
...
#endif
vPatchPosition=position.xy;}`;e.ShadersStore[o]||(e.ShadersStore[o]=s);var c=[r,t,n,i,a];for(let t of c)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var l={name:o,shader:s};export{l as gaussianSplattingVoxelVertexShader};